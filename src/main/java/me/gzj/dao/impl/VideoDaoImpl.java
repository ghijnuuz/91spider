...
public class VideoDaoImpl implements IVideoDao {
    ...
    public Video getVideo(String viewkey) {
        return datastore.createQuery(Video.class).field("viewkey").equal(viewkey).get();
    }
    ...
    public int saveVideo(Video video) {
        Query<Video> query = datastore.createQuery(Video.class).field("viewkey").equal(video.getViewkey());
